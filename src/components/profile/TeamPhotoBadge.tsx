...
export function TeamPhotoBadge({
  ...
  const shapeClassName = shape === "square" ? "rounded-[10px]" : "rounded-full";

  return (
    <div
      className={cn(
        "relative overflow-hidden border border-primary/25 bg-background/80 shadow-[0_0_30px_hsl(51_100%_50%_/_0.12)]",
        sizeClassName,
        shapeClassName,
        className,
      )}
